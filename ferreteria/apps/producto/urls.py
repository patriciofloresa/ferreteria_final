...
from .views import(MarcaNew,MarcaEditar,MarcaDelete,MarcaView,CategoriaView,CategoriaNew,CategoriaEditar,CategoriaDelete,TipoProductoView,TipoProductoNew,
TipoProductoEditar,TipoProductoDelete,ProductoNew,ProductoView,ProductoEditar,ProductoDelete,añadircarrito,deleteCarrito, delete_cart_shopping,deletetodocarrito,
deletetodoProducto,deletetodoCategoria,deletetodoTipoProducto,deletetodoMarca)
from . import views
...
urlpatterns = [ 
    ...
    path('detallecarrito/<int:pk>/',views.detallecarrito,name='detallecarrito'),

...
urlpatterns = [
    ...
    path(
        "home/",
        staff_member_required(TemplateView.as_view(template_name="index.html")),
        name="home",
    ),
    ...
    path(
        "redireccion/",
        TemplateView.as_view(template_name="redireccion.html"),
        name="redirect",
    ),
    # url cuentas#
    ...
    path(
        "ListarCategoria/edit/<int:pk>",
        ListarCategorias.as_view(),
        name="Listar_categorias",
    ),
    path(
        "Detalleproducto/<int:pk>",
        DetailViewProducto.as_view(),
